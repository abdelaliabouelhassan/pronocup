<template>
      <div @click="toggleOpen" class=" w-full bg-[#F9FAFB] dark:bg-[#1E2120]  cursor-pointer duration-200 p-[2.5rem]  hover:bg-[#ECF7F2] dark:hover:bg-[#384640] rounded-[2rem] flex flex-col items-start space-y-8">
